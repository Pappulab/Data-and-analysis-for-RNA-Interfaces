...
figureSaveDirectory = "C:\Users\q.yuanxin\Box\LewLab_Yuanxin\Projects\RNA condensates - poly-rA interface diffusion\figures\panelB";
...
for i=1:length(dataNum)
    if laserPower(i)<45 %%
        ...
        radiusNorm = radiusData./Radius_set;
        ...
        subplot(211,'Position',[0.07,0.456,0.95,0.5]); imagesc(imresize(cropData,resizefactor,'method','nearest'));  colormap gray; hcb = colorbar; axis image; box off; axis off; caxis([0,300]);
        ...
        hcb.FontSize = 11;
        hcb.Color = 'k';
        subplot(212,'Position',[0.18,0.11,0.68,0.32]); hold on; xlabel('$R$','Interpreter','latex'); ylabel('photons');
...
%%
        ...
        hcb.FontSize = 11;
        hcb.Color = 'k';
        subplot(212,'Position',[0.18,0.11,0.68,0.32]); hold on; xlabel('$R$','Interpreter','latex'), ylabel('Summed Locs');
